...
namespace DynaPlex::Models {
	namespace exact_test_case/*must be consistent everywhere for complete mdp definition and associated policies and states (if not defined inline).*/
	{		
		class MDP
		{			
		public:	
			double discount_factor;
			DynaPlex::DiscreteDist dist;
