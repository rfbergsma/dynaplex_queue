...
namespace DynaPlex::Models {
	namespace collaborative_picking {
		...
		using ScheduledEvent = ScheduledEventType<TimeStep, PickerAwaitsAction, PickerArrival, PickerCheckDeadlock, PickCompletes, MakeNodeAccessible, VehicleNodeEntry, VehicleReadyForPick, ConfigurePickRun>;
	}
}