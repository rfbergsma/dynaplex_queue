...
namespace DynaPlex::Tests {
	...
	TEST(ExactAlgorithm, LostSalesSmallInstances) {
		...
		//This to ensure that the base-stock policy actually is free to order as it likes - note 
		//that normally order sizes in this MDP are bound to the maximum optimal order size as proven by Zipkin. 
