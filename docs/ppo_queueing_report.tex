...
this scale.  This is the first instance larger than the two-type
benchmarks, on the most realistic objective, and the result is a clean
8/8.  Extension to four- and six-type chains (where RVI is intractable and
policies are judged against FIFO/c-$\mu$) is the immediate next step.
